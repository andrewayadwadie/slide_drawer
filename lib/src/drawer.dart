...
import 'package:slide_drawer/src/item.dart' as slideItem;
...
class SlideDrawer extends StatefulWidget {
  ...
  /// List of [slideItem.MenuItem] to be used to generate the default content drawer
  final List<slideItem.MenuItems> items;
